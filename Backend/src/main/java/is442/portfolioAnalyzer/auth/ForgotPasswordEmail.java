...
public class ForgotPasswordEmail {
  ...
  /*
   * Process:
   * - DONE - User click on "Forgot Password" link
   * - DONE - Random authToken is generated by backend (random hashvalue that can
   * be checked)
   * - DONE - Endpoint with authToken link is sent to their email address
